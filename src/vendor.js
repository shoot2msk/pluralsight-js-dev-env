...
in the production build onlly*. A separate bundle for vendor
...
code changes. They only have to download vendor.js when
a vendor library changes which should be less frequent.
Any filess that aren't referenced here will be bundled into
